    ...
    <div className="relative z-20 min-h-screen overflow-hidden bg-[#0a0a0a] px-6 py-28 md:py-32">
      ...
      <div className="relative z-10 mx-auto max-w-6xl text-white">
        ...
        >
          ...
          <h2 className="mb-6 bg-gradient-to-br from-white via-white to-gray-500 bg-clip-text text-5xl font-extrabold tracking-tighter text-transparent md:text-7xl">
            Hannan Rasool
          </h2>
