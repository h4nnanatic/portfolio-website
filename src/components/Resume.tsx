  ...
  const marketingProjects: MarketingProject[] = [
    {
      ...
      outcomes: [
        "Developed a dessert-focused creative branding direction for Dripy.pk.",
        "Translated brand ideas into coordinated marketing campaign concepts.",
        "Designed dessert-led campaign visuals with an emphasis on product appeal.",
        "Aligned campaign layouts, typography, and color treatments with the brand style.",
        "Maintained a consistent visual presentation across the campaign creative set.",
      ],
    ...
    },
    {
      ...
      outcomes: [
        "Developed creative branding concepts for Givmoo, a US marketplace.",
        "Translated marketplace messaging into clear visual campaign concepts.",
        "Designed marketing campaign creatives aligned with the brand identity.",
        "Structured campaign layouts around clear messaging and visual hierarchy.",
        "Maintained consistent typography, color treatments, and brand presentation across creatives.",
      ],
      ...
      <div className="relative z-10 mx-auto max-w-6xl text-white">
        ...
        >
          ...
          <div className="mb-6 flex flex-wrap items-center gap-6">
            ...
            <a
              href="https://www.instagram.com/hannancreativeco?igsh=bDlwcmVmcGNodWww&utm_source=qr"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 rounded-full bg-gradient-to-tr from-yellow-500 via-pink-500 to-purple-600 px-5 py-2.5 text-sm font-semibold text-white shadow-lg transition-all hover:-translate-y-0.5 hover:opacity-90"
            >
